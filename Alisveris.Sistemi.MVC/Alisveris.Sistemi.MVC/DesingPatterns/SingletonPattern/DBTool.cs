...
namespace Alisveris.Sistemi.MVC.DesingPatterns.SingletonPattern
{
    using Alisveris.Sistemi.MVC.Models.Context;//MyContext class'ımızı tanıyabilmesi için, namespace tanımlaması yaptık
